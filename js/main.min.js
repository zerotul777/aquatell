...
/***/ "./js/modules/main-nav/init-main-nav.js":
/*!**********************************************!*\
  !*** ./js/modules/main-nav/init-main-nav.js ***!
  \**********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initMainNav: function() { return /* binding */ initMainNav; }
/* harmony export */ });
/* harmony import */ var _main_nav__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main-nav */ "./js/modules/main-nav/main-nav.js");

var initMainNav = function initMainNav() {
  var mainnav = new _main_nav__WEBPACK_IMPORTED_MODULE_0__.MainNav();
  mainnav.init();
};
...
/***/ "./js/modules/main-nav/main-nav.js":
/*!*****************************************!*\
  !*** ./js/modules/main-nav/main-nav.js ***!
  \*****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var MainNav = /*#__PURE__*/function () {
  function MainNav() {
    ...
    this._mainNav = document.querySelector('[data-main-nav]');
    this._toggles = document.querySelectorAll('[data-toggle-nav]');
    this._scrollLock = new _utils_scroll_lock_js__WEBPACK_IMPORTED_MODULE_0__.ScrollLock();
    this._focusLock = new _utils_focus_lock_js__WEBPACK_IMPORTED_MODULE_1__.FocusLock();
    this._isMenuOpen = false;
    this._onToggleClick = this._onToggleClick.bind(this);
  ...
  return _createClass(MainNav, [{
    ...
    value: function init() {
      var _this = this;
      if (!this._toggles.length || !this._mainNav) {
        console.warn('MainNav or Toggles not found');
        return;
      }
      this._toggles.forEach(function (toggle) {
        toggle.addEventListener('click', _this._onToggleClick);
      });
    }
  }, {
    key: "_openMenu",
    value: function _openMenu() {
      this._isMenuOpen = true;
      this._mainNav.classList.add('is-open');

      // Добавляем класс is-active всем кнопкам
      this._toggles.forEach(function (toggle) {
      ...
      document.addEventListener('keydown', this._onDocumentKeydown);
      document.addEventListener('click', this._onDocumentClick);
      this._focusLock.lock('[data-main-nav]');
    }
  }, {
    key: "_closeMenu",
    value: function _closeMenu() {
      this._isMenuOpen = false;
      this._mainNav.classList.remove('is-open');
      this._toggles.forEach(function (toggle) {
      ...
      document.removeEventListener('keydown', this._onDocumentKeydown);
      document.removeEventListener('click', this._onDocumentClick);
      this._focusLock.unlock('[data-main-nav]');
    }
  }, {
    key: "_onToggleClick",
    value: function _onToggleClick() {
...
var Validation = /*#__PURE__*/function () {
  ...
  return _createClass(Validation, [{
    ...
    value: function _initFileUpload(form) {
      var _this2 = this;
      var attachmentBtn = form.querySelector('[data-attachment-btn]');
      if (attachmentBtn) {
        attachmentBtn.addEventListener('click', function (e) {
          ...
          fileInput.addEventListener('change', function () {
            ...
            var filesContainer = form.querySelector('[data-attachment-files]');
...
/* harmony import */ var _modules_main_nav_init_main_nav__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/main-nav/init-main-nav */ "./js/modules/main-nav/init-main-nav.js");
...
/* harmony import */ var _modules_slider_init_completed_projects_slider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/slider/init-completed-projects-slider */ "./js/modules/slider/init-completed-projects-slider.js");
/* harmony import */ var _modules_slider_init_intro_slider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/slider/init-intro-slider */ "./js/modules/slider/init-intro-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_main_nav_init_main_nav__WEBPACK_IMPORTED_MODULE_6__.initMainNav)();
  (0,_modules_slider_init_completed_projects_slider__WEBPACK_IMPORTED_MODULE_8__.initCompletedProjectsSlider)();
  ...
  (0,_modules_slider_init_intro_slider__WEBPACK_IMPORTED_MODULE_9__.initIntroSlider)();
